  ...
  render () {
    ...
    return (
      <div className="preference">
        ...
        <div className="pref">
          <div className="col-md-11 pref"><Cuisine changeCuisineStatus={this.changeCuisineStatus} cuisineStatus={this.state.preferenceState.cuisineStatus} /></div>
          ...
          <div className="col-md-11 pref"><PriceRange changePrice={this.changePrice} priceStatus={this.state.preferenceState.priceStatus}/></div>
          <br></br>
        </div>
